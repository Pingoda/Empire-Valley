...
give @s paper{display:{Name:'{"text":"Computer di Hunter","color":"blue","bold":true}',Lore:['{"text":"Un Computer WINDOWS utilizzato","color":"gray","italic":true}','{"text":"per entrare nei Sistemi Informatici","color":"gray","italic":true}','{"text":"della NASA e di Angelo Calemme.","color":"gray","italic":true}']},HideFlags:255} 1

# Tellraw @a
tellraw @a ["",{"text":"[","color":"gray"},{"text":"Empire","bold":true},{"text":"Valley","bold":true,"color":"green"},{"text":"]","color":"gray"},{"text":" ","color":"#DDDDDD"},{"selector":"@s","color":"gold"},{"text":" ha craftato le ","color":"#DDDDDD"},{"text":"[","color":"gray","hoverEvent":{"action":"show_text","contents":{"text":"Un Computer WINDOWS utilizzato\nper entrare nei Sistemi Informatici\ndella NASA e di Angelo Calemme.","italic":true,"color":"gray"}}},{"text":"Computer di Hunter","color":"blue","hoverEvent":{"action":"show_text","contents":{"text":"Un Computer WINDOWS utilizzato\nper entrare nei Sistemi Informatici\ndella NASA e di Angelo Calemme.","italic":true,"color":"gray"}}},{"text":"]","color":"gray","hoverEvent":{"action":"show_text","contents":{"text":"Un Computer WINDOWS utilizzato\nper entrare nei Sistemi Informatici\ndella NASA e di Angelo Calemme.","italic":true,"color":"gray"}}}]