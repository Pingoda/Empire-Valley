...
give @s beetroot{display:{Name:'[{"text":"Red","color":"red","bold":true,"italic":false},{"text":"Bull","color":"gold","bold":true},{"text":" di Zanjo","color":"gray","bold":true}]',Lore:['{"text":"Sarà come quella della pubblicità?","color":"gray","italic":true}']},HideFlags:255,redbull:1b,CustomModelData:216} 1

# Tellraw @a
tellraw @a ["",{"text":"[","color":"gray"},{"text":"Empire","bold":true},{"text":"Valley","bold":true,"color":"green"},{"text":"]","color":"gray"},{"text":" ","color":"#DDDDDD"},{"selector":"@s","color":"gold"},{"text":" ha craftato la ","color":"#DDDDDD"},{"text":"[","color":"gray","hoverEvent":{"action":"show_text","contents":{"text":"Sarà come quella della pubblicità?","italic":true,"color":"gray"}}},{"text":"Red","color":"red","hoverEvent":{"action":"show_text","contents":{"text":"Sarà come quella della pubblicità?","italic":true,"color":"gray"}}},{"text":"Bull","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"Sarà come quella della pubblicità?","italic":true,"color":"gray"}}},{"text":" ","color":"light_purple","hoverEvent":{"action":"show_text","contents":{"text":"Sarà come quella della pubblicità?","italic":true,"color":"gray"}}},{"text":"di Zanjo]","color":"gray","hoverEvent":{"action":"show_text","contents":{"text":"Sarà come quella della pubblicità?","italic":true,"color":"gray"}}}]