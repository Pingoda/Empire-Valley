...
give @p paper{display:{Name:'{"text":"Libro di Berty","color":"dark_purple","bold":true}',Lore:['{"text":"Tutti i segreti di Berty sono contenuti in questo libro...","color":"gray","italic":true}']},HideFlags:255} 1

# Tellraw @a
tellraw @a ["",{"text":"[","color":"gray"},{"text":"Empire","bold":true},{"text":"Valley","bold":true,"color":"green"},{"text":"]","color":"gray"},{"text":" ","color":"#DDDDDD"},{"selector":"@s","color":"gold"},{"text":" ha craftato ","color":"#DDDDDD"},{"text":"[","color":"gray","hoverEvent":{"action":"show_text","contents":{"text":"Tutti i segreti di Berty sono contenuti in questo libro...","italic":true,"color":"gray"}}},{"text":"Libro di Berty","color":"dark_purple","hoverEvent":{"action":"show_text","contents":{"text":"Tutti i segreti di Berty sono contenuti in questo libro...","italic":true,"color":"gray"}}},{"text":"]","color":"gray","hoverEvent":{"action":"show_text","contents":{"text":"Tutti i segreti di Berty sono contenuti in questo libro...","italic":true,"color":"gray"}}}]