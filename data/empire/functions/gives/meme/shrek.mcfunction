...
give @s paper{display:{Name:'{"text":"Shrek","color":"dark_green","bold":true}',Lore:['{"text":"Un Orco molto gentile che vive in una palude...","color":"gray","italic":true}','{"text":"Gli Orchi sono come le cipolle, a strati!","color":"gray","italic":true}']},HideFlags:255,CustomModelData:203} 1
